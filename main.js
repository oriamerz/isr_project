...
var cities = [
    {
        ...
        icons: { position: [[33, 90], [10, 77], [76, 37], [76, 21]], text: ["בית כנסת", "פארק", "מכולת", "ספריה"] }
    },
    {
        id: 2,
        city_name: "כוכב השחר",
        ...
        icons: { position: [[20, 43], [76, 21], [76, 37], [44, 15],], text: ["בית כנסת", "פארק", "מכולת", "ספריה"] }
    },
    {
        id: 3,
        city_name: "רימונים",
        ...
        icons: { position: [[11, 55], [76, 37], [76, 3], [11, 2]], text: ["בית כנסת", "פארק", "מכולת", "ספריה"] }
    },
    {
        id: 4,
        city_name: "חיפה",
        ...
        icons: { position: [[89, 98], [44, 15], [76, 37], [20, 43]], text: ["בית כנסת", "פארק", "מכולת", "ספריה"] }
    }
]
